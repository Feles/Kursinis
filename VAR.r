VARselect(Data.m, lag.max = 4, type = "trend")
...
colnames(vec.coefs) <- c('$\\Delta\\text{vki}_t$', '$\\Delta\\text{oil}_t$', '$\\Delta\\text{ned}_t$', '$\\Delta\\text{libor}_t$')
rownames(vec.coefs) <- c('Konstanta', '$\\Delta\\text{vki}_{t-1}$',  '$\\Delta\\text{oil}_{t-1}$', '$\\Delta\\text{ned}_{t-1}$',  '$\\Delta\\text{libor}_{t-1}$','$\\Delta\\text{vki}_{t-2}$',  '$\\Delta\\text{oil}_{t-2}$', '$\\Delta\\text{ned}_{t-2}$',  '$\\Delta\\text{libor}_{t-2}$', 'Laikas')
...
colnames(var.coefs) <- c('$\\text{vki}_t$', '$\\text{oil}_t$', '$\\text{ned}_t$', '$\\text{libor}_t$')
